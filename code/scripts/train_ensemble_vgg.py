...
ENSEMBLE_SAVE_NAME = 'vgg'  # Name that the ensemble models will be saved with
NAME_START_NUMBER = 85  # Start number for model naming (set to 0 unless continuing previous training)
