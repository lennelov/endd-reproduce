...
test_image_ID_uncertain = (test_images[ID_index[0],:,:,:]+test_images[ID_index[1],:,:,:]+test_images[ID_index[5],:,:,:])/3 #0,1,5 are all different classes
...
ensemble_alphas_OOD = ensemble_alphas_OOD/np.expand_dims(np.sum(ensemble_alphas_OOD,axis =1),axis =1)
ensemble_alphas_ID_uncertain = ensemble_alphas_ID_uncertain/np.expand_dims(np.sum(ensemble_alphas_ID_uncertain,axis =1),axis =1)
