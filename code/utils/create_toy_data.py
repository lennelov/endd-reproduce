...
'''
This file is stole from Kaos Engineer's github https://github.com/KaosEngineer/PriorNetworks/blob/master/prior_networks/datasets/toy/classification/spiral.py
to recreate the results from https://papers.nips.cc/paper/7936-predictive-uncertainty-estimation-via-prior-networks.pdf
'''
